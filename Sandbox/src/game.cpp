...
#else
	m_pShader = new Shader("shaders/vertexShader.shader", "shaders/fragmentShader.shader");
#endif
...
#else
	m_pSprite = new Sprite(1.0f, 1.0f, 4, 4, new Texture("tex", "res/tb32.png"));
#endif
...
#else
	audio::SoundManager::add(new audio::Sound("iphoneSong", "res/iphone.wav"))->loop();
#endif
